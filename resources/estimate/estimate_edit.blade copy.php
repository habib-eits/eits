...
<h3>QUOTATION</h3>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="UserID" id="UserID" class="form-select select2" style="width:100%;>
                                            ...
                                            <?php foreach ($user as $key => $value) : ?>
                                                <option value="{{$value->id}}" {{($value->id== $estimate_master[0]->UserID) ? 'selected=selected':'' }} >{{$value->name}}</option>
                                            <?php endforeach ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="mb-1 row d-none">
                                 ...
                                 <div class="col-sm-9">
                                       <input type="text" id="first-name" class="form-control" name="InquiryNo" value="{{$estimate_master[0]->InquiryNo}}">
                                    </div>
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="first-name" class="form-control" name="EquipmentUser_PlantSite" value="{{$estimate_master[0]->EquipmentUser_PlantSite}}">
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="first-name" class="form-control" name="VendorReference" value="{{$estimate_master[0]->VendorReference}}" >
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="first-name" class="form-control" name="OriginMaterial" value="{{$estimate_master[0]->OriginMaterial}}">
                                        </div>
                                    </div>
 ...
 <option value="TaxInclusive" {{($estimate_master[0]->TaxType=='TaxInclusive' ) ? 'selected=selected':'' }}>Tax Inclusive</option>
 <option value="TaxExclusive" {{($estimate_master[0]->TaxType=='TaxExclusive' ) ? 'selected=selected':'' }}>Tax Exclusive</option>
 </select>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="BranchID" id="BranchID" class="form-select">
                                                <?php foreach ($branch as $key => $value) : ?>
                                                    <option value="{{$value->BranchID}}" {{($value->BranchID== $estimate_master[0]->BranchID) ? 'selected=selected':'' }}>{{$value->BranchName}}</option>
                                                <?php endforeach ?>
                                            </select>
                                ...
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        <div class="col-sm-3">
                                            <label class="col-form-label text-danger" for="password">Quotation # </label>
                                        </div>
                                        <div class="col-sm-9">
                                            <div id="invoict_type"> <input type="text" name="EstimateNo" autocomplete="off" id="EstimateNo" class="form-control" required="" value="{{$estimate_master[0]->EstimateNo}}"></div>
                                    ...
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group" id="datepicker21">
                                                <input type="text" name="Date" autocomplete="off" class="form-control" placeholder="yyyy-mm-dd" data-date-format="yyyy-mm-dd" data-date-container="#datepicker21" data-provide="datepicker" data-date-autoclose="true" value="{{$estimate_master[0]->Date}}">
                                    ...
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group" id="datepicker22">
                                                <input type="text" name="ExpiryDate" autocomplete="off" class="form-control" placeholder="yyyy-mm-dd" data-date-format="yyyy-mm-dd" data-date-container="#datepicker22" data-provide="datepicker" data-date-autoclose="true" value="{{$estimate_master[0]->ExpiryDate}}">
                                                <span class="input-group-text"><i class="mdi mdi-calendar"></i></span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="ReferenceNo" autocomplete="off" class="form-control" value="{{$estimate_master[0]->ReferenceNo}}">
                                  ...
                                  <div class="col-12 d-none">
                                        <div class="mb-1 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="Country" autocomplete="off"
                                                    class="form-control" value="{{$estimate_master[0]->Country}}">
                                        ...
                                        <div class="mb-1 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="Equipment" autocomplete="off"
                                                    class="form-control" value="{{$estimate_master[0]->Equipment}}">
                                        ...
                                        <div class="mb-1 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="Type" autocomplete="off"
                                                    class="form-control" value="{{$estimate_master[0]->Type}}">
                                        ...
                                        <div class="mb-1 row">
                                            <div class="col-sm-3">
                                                <label class="col-form-label" for="password">Sectional Assembly Group </label>
                                            </div>
                                            <div class="col-sm-9">
                                                <input type="text" name="SectionalAssemblyGroup" autocomplete="off"
                                                    class="form-control" value="{{$estimate_master[0]->SectionalAssemblyGroup}}">
                                ...
                                <table >
                                    <thead>
                                        <tr class=" borde-1 border-light " style="height: 40px;">
                                            ...
                                            <th width="4%" class="d-none">UNIT</th>
                                            <th width="4%" class="d-none">UNIT/Qty</th>
                                    ...
                                    <tbody>
                                        ...
                                        <!-- start of loop -->
                                        @foreach($estimate_detail as $value1)
                                        <tr class="p-3" >
                                          <td bordercolor="1" valign="top" align="left"><input class="case" type="checkbox" /></td>

                                          <td valign="top">
    <select name="services_id[]" id="services_id_1" class="item form-select  form-control-sm select2 "  style="width: 300px !important; margin-bottom: 5px;">
                                                    <option value="">select</option>
                                                    @foreach ($services as $key => $value)
                                                    <option @if($value->id == $value1->services_id) selected @endif value="{{$value->id}}">
                                                        {{ $value->name }}</option>
                                                    @endforeach
                                                </select>
                                                ...
                                                <select name="ItemID0[]" id="ItemID0_1" class="item form-select  form-control-sm select2   changesNoo " onchange="km(this.value,1);" style="width: 300px !important;">
                                                    ...
                                                    <option @if($value->ItemID == $value1->ItemID) selected @endif value="{{$value->ItemID}}" {{($value->ItemID== $value1->ItemID) ? 'selected=selected':'' }} >{{$value->ItemName}}</option>
                                                    @endforeach
                                                </select>
                                                <input type="hidden" name="ItemID[]" id="ItemID_1" value="{{$value1->ItemID}}">
                                          <textarea name="Description[]" id="Description[]" rows="2" class="form-control mt-1 kashif" style="width: 300px !important;">{{$value1->Description}}</textarea></td>

                                          <td valign="top" class="d-none"><select name="UnitName[]" id="UnitName_1" class="form-select">
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-lg-8 col-12  ">
                                <h6>Customer Notes: </h6>
                                 ...
                                 <textarea class="form-control editme" rows='5' name="CustomerNotes" id="note" placeholder="">{!!$estimate_master[0]->CustomerNotes!!}</textarea>
                               ...
                               <textarea class="form-control editme " rows='5' name="DescriptionNotes" id="note">
                                   {!!$estimate_master[0]->DescriptionNotes!!}
                                    ...
                                    <textarea class="form-control editme" rows='5' name="CoveringLetter" id="CoveringLetter"
                                         >
                                ...
                                <form class="form-inline">
                                    <div class="form-group mt-1">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="grandtotaltax" name="grandtotaltax" placeholder="Subtotal" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" value="{{$estimate_master[0]->Tax}}">
                                        </div>
                                    </div>
                                    <div class="form-group mt-1">
                                    ...
                                    <div class="form-group mt-1">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" value="0" id="discountper" name="DiscountPer" placeholder="Tax" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" value="{{$estimate_master[0]->DiscountPer}}">
                                    ...
                                    <div class="form-group mt-1">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text bg-light">{{session::get('Currency')}}</span>
                                            <input type="number" name="Grandtotal"  id="Grandtotal" class="form-control" step="0.01" id="grandtotal" placeholder="Grand Total"   onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" value="{{$estimate_master[0]->GrandTotal}}">
                                        </div>
                                    </div>
...
<!--                                         <label>Payment Plan: &nbsp;</label>
        ...
        <tbody>
            ...
            <tr>
                <td><input type="text" class="paymentPercentage" name="PaymentPercentage[]" /></td>
                <td><input type="hidden" class="amount" id="amount" /></td>
                <td><button class="deleteRowBtn btn btn-danger btn-sm" type="button" > <i class="bx bx-trash align-middle font-medium-3 me-25"></i>Delete</button></td>
            </tr>
            {{-- @endforeach --}}
        </tbody>
        <tfoot>
            <tr>
                <td><strong>Total Percentage:</strong> <span id="totalPercentage">0</span>%</td>
                <td></td>
                <td><button class="btn btn-success btn-sm" type="button" id="addRowBtn"><i class="bx bx-list-plus align-middle font-medium-3 me-25"></i> Add </button></td>
            </tr>
        </tfoot>
    </table> -->
    ...
    <script>
        $(document).ready(function(){
            function calculateTotalPercentage() {
                let total = 0;
                $(".paymentPercentage").each(function() {
            ...
            $("#addRowBtn").click(function(){
                var newRow = `<tr>
                                <td><input type="text" class="paymentPercentage" name="PaymentPercentage[]"/></td>
                                <td><input type="hidden" class="amount" /></td>
                                <td><button class="deleteRowBtn btn btn-danger btn-sm"><i class="bx bx-trash align-middle font-medium-3 me-25"></i> Delete</button></td>
                              </tr>`;
            ...
            $(document).on("input", ".paymentPercentage", function(){
...
<script>
    ...
    $(".addmore").on('click', function() {
        ...
        html += '<td>   <select name="services_id[]" id="services_id_'+ i + '" class="item form-select  form-control-sm select2 "  style="width: 300px !important; margin-bottom: 5px;"><option value="">select</option> @foreach ($services as $key => $value) <option value="{{$value->id}}" >{{$value->name}}</option>   @endforeach                                                 </select> <select name="ItemID0[]" id="ItemID0_' + i + '"  style="width: 300px !important;" class="form-select select2  changesNoo" onchange="km(this.value,' + i + ');" > <option value="">select</option>}@foreach ($items as $key => $value) <option value="{{$value->ItemID}}|{{$value->Percentage}}">{{$value->ItemCode}}-{{$value->ItemName}}-{{$value->Percentage}}</option>@endforeach</select><input type="hidden" name="ItemID[]" id="ItemID_' + i + '"> <textarea name="Description[]" id="Description[]" rows="2" class="form-control mt-1 kashif" style="width: 300px !important;"></textarea></td>';


html += ' <td valign="top" class="d-none"><select name="UnitName[]" id="UnitName_'+ i + '" class="form-select">                                          @foreach($unit as $value)     <option value="{{$value->UnitName}}">{{$value->UnitName}}</option>                                              @endforeach                                          </select></td>                                             ';

html += '<td valign="top" class="d-none"> <input type="number" name="UnitQty[]" id="UnitQty_'+ i + '" class=" form-control changesNo " autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" value="">                                            </td>';


         html += '<td valign="top"><input type="text" name="Qty[]" id="Qty_' + i + '" class="form-control changesNo QtyTotal" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" value="1"> <select  class="form-select mt-1 d-none" name="LS[]" id="LS_' + i + '"><option value="NO">LS / NO</option><option value="YES"> L/S YES</option>            </select></td>';
