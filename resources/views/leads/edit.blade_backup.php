                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ url('updatelead', $lead->id) }}" method="post">
                                    ...
                                    {{-- <div class="row mt-2"> --}}
                                        ...
                                        <div class="col-lg-4 col-md-6 col-sm-12">
                                            ...
                                            <select name="agent_id" id="agent_id" class="form-select select2">
                                                ...
                                                <option value="{{ $agent->id }}" {{ $lead->agent_id == $agent->id ?
                                                    'selected' : '' }}>{{ $agent->name }}
                                                </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-md-9 col-sm-12">
                                            ...
                                            <textarea name="remarks" id="" cols="30" rows="3"
                                                class="form-control" >{{ $lead->remarks }}</textarea>
                                        </div>
                                    ...
                                    <div class="d-flex justify-content-end mt-2">
                                        <button type="submit" id="back" class="btn btn-primary me-2">Update and go
                                            back</button>
