...
@section('content')
    ...
    <div class="main-content">
        <div class="page-content">
                ...
                <div class="content-wrapper">
                    <div class="row" style="height: 81vh; overflow: auto;">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="{{ url('updatelead', $lead->id) }}" method="post">
                                        ...
                                        <input type="hidden" value="{{ Session::get('previous_url') }}"
                                            name="previous_url">
                                        <div class="row">
                                            <div class="col-lg-4 col-md-6 col-sm-12">
                                                <label><b>Customer</b> </label>
                                                <select name="partyid" id="PartyID"
                                                    class="form-select select2 mt-5"required="" style="width:100%;">
                                                    <option value="">Select</option>
                                                    <?php foreach ($party as $key => $value) : ?>
                                                    <option value="{{ $value->PartyID }}"
                                                        {{ $value->PartyID == $lead->partyid ? 'selected=selected' : '' }}>
                                            ...
                                            <div class="col-lg-4 col-md-6 col-sm-12">
                                                <label for="tel"><strong>Phone No</strong></label>
                                                <input type="text" name="" id="" readonly
                                                    class="form-control" value="{{ $lead->tel }}">
                                            </div>
                                            {{-- <div class="col-lg-4 col-md-6 col-sm-12">
                                            ...
                                            <div class="col-lg-4 col-md-6 col-sm-12">
                                                ...
                                                <select name="channel" id="channel" class="form-select select2">
                                                    ...
                                                    @foreach ($channel as $value)
                                                        <option value="{{ $value->ChannelName }}"
                                                            {{ $value->ChannelName == $lead->channel ? 'selected=selected' : '' }}>
                                                            {{ $value->ChannelName }}
                                                        </option>
                                                    @endforeach
                                            ...
                                            <div class="col-4 {{ $lead->service_id != null ? '' : 'd-none' }}"
                                                id="subServiceCol">
                                            ...
                                            <div class="col-lg-4 col-md-6 col-sm-12 d-none">
                                                ...
                                                <select name="currency" id="currency" class="form-select select2">
                                                    ...
                                                    <option value="AED"
                                                        {{ $lead->currency == 'AED' ? 'selected' : '' }}>AED
                                                    </option>
                                                    <option value="USD"
                                                        {{ $lead->currency == 'USD' ? 'selected' : '' }}>USD
                                                    </option>
                                                ...
                                                <select name="agent_id" id="agent_id" class="form-select select2">
                                                    ...
                                                    @foreach ($agents as $agent)
                                                        <option value="{{ $agent->id }}"
                                                            {{ $lead->agent_id == $agent->id ? 'selected' : '' }}>
                                                            {{ $agent->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                                ...
                                                <select name="campaign_id" id="campaign_id" class="form-select select2">
                                                    ...
                                                    @foreach ($campaigns as $campaign)
                                                        <option value="{{ $campaign->id }}"
                                                            {{ $lead->campaign_id == $campaign->id ? 'selected' : '' }}>
                                            ...
                                            <div class="col-lg-4 col-md-6 col-sm-12 {{ $lead->status == 'Assigned' ? '' : 'd-none' }}"
                                                ...
                                                <select name="qualified_status" id="qualified_status"
                                                    class="form-select  ">
                                        ...
                                        <div class="row mt-2">
                                            <div class="col-md-9 col-sm-12">
                                                ...
                                                <textarea name="remarks" id="" cols="30" rows="3" class="form-control">{{ $lead->remarks }}</textarea>
                                            </div>
                                        ...
                                        <div class="d-flex justify-content-end mt-2">
                                            <button type="submit" id="back" class="btn btn-primary me-2">Update and
                                                go
                                                back</button>
                                                    ...
                                                    @foreach ($lead_activities as $lead_activity)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <button @if ($diffInHours > 2) disabled @endif
                                                                    class="editActivityButton btn btn-sm btn-warning"
                                                                    data-id="{{ $lead_activity->id }}">Edit</button>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Followup History</h3>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                            ...
                                            <table class="table align-middle mb-0">
                                                ...
                                                <thead>
                                                    <tr>
                                                        <th class="col-md-1 text-left">No</th>
                                                        <th class="col-md-2 text-left">Date</th>
                                                        <th class="col-md-4 text-left">Remarks</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($followups as $followup)
                                                        <tr>
                                                            <td scope="row">{{ $i++ }}</td>
                                                            <td scope="row">{{ $followup->date }}</td>
                                                            <td scope="row">{{ $followup->remarks }}</td>
                                                            <td scope="row">{{ $followup->notes }}</td>
            ...
            <div class="modal fade exampleModal" id="createFollowUpModal" tabindex="-1" role="dialog"
            ...
            <div class="modal fade exampleModal" id="editCustomer" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form id="update-customer" action="{{ URL('/PartiesUpdate1') }}" method="post">
                            
                            @csrf
                            <input type="hidden" name="PartyID" value="{{ $current_party->PartyID }}">
                            ...
                            <div class="modal-body">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-12">
                                                <label for="description">Customer Name</label><br>
                                                <input type="text" class="form-control" name="PartyName" value="{{ $current_party->PartyName }}">
                                            </div>
                                            <div class="col-12">
                                                <label for="description">Phone</label><br>
                                                <input type="text" class="form-control" name="Phone" value="{{ $current_party->Phone }}">
                                            </div>
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                <button type="submit" id="modelButton" class="btn btn-primary">Update</button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <script>
                $(document).ready(function() {
                    ...
                    $('#addActivityButton').click(function() {
                        ...
                        $('#follow_up_date').val('');
                        $('#description').val('');
                        $('#exampleModalLabel').text('Add Notes / Remarks');
