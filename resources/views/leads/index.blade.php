                        ...
                        <div class="row mt-2">
                            <div class="col-lg-2 col-md-4 col-sm-6">
                                ...
                                <select name="filter_status" id=""
                                    ...
                                    <option value="">
                                        {{ isset($request) && $request->filter_status ? '--Cancel--'
                                        : '--Select One--' }}
                                    </option>
                                    @foreach ($statuses as $status)
                                    <option value="{{ $status->name }}" {{ isset($request) &&
                                        $request->filter_status == $status->name ? 'selected' : ''
                                        }}>
                                        {{ $status->name }}
                                    </option>
                                    @endforeach
                            ...
                            <div class="col-lg-2 col-md-4 col-sm-6">
                                ...
                                <select name="filter_channel_name" id=""
                                    class="form-control select2 rounded">
                                    <option value="">
                                        {{ isset($request) && $request->filter_channel_name ? '--Cancel--'
                                        : '--Select One--' }}
                                    </option>
                                    @foreach ($channels as $channel)
                                    <option value="{{ $channel->ChannelName }}" {{ isset($request) &&
                                        $request->filter_channel_name == $channel->ChannelName ? 'selected' : ''
                                        }}>
                                        {{ $channel->ChannelName }}
                                    </option>
                                    @endforeach
                            ...
                            <div class="col-lg-2 col-md-4 col-sm-6 d-none">
                                ...
                                <select name="filter_campaign_id" id=""
                                    class="form-control select2 rounded">
                                    <option value="">
                                        {{ isset($request) && $request->filter_campaign_id ?
                                        '--Cancel--' : '--Select One--' }}
                                    </option>
                                    <option value="-1" {{ isset($request) && $request->
                                        filter_campaign_id == -1 ? 'selected' : '' }}>
                                        No Campaign</option>
                                    @foreach ($campaigns as $campaign)
                                    <option value="{{ $campaign->id }}" {{ isset($request) &&
                                        $request->filter_campaign_id == $campaign->id ? 'selected' :
                                        '' }}>
                            ...
                            <div class="col-lg-2 col-md-4 col-sm-6">
                                ...
                                <select name="filter_service_id" id=""
                                    class="form-control select2 rounded">
                                    <option value="">
                                        {{ isset($request) && $request->filter_service_id ?
                                        '--Cancel--' : '--Select One--' }}
                                    </option>
                                    <option value="-1" {{ isset($request) && $request->
                                        filter_service_id == -1 ? 'selected' : '' }}>
                                        No Campaign</option>
                                    @foreach ($services as $service)
                                    <option value="{{ $service->id }}" {{ isset($request) &&
                                        $request->filter_service_id == $service->id ? 'selected' :
                                        '' }}>
                                        {{ $service->name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-lg-2 col-md-4 col-sm-6">
                                ...
                                <select name="filter_Q_status" id=""
                                    class="form-control select2 rounded">
                                    <option value="">
                                        {{ isset($request) && $request->filter_Q_status ?
                                        '--Cancel--' : '--Select One--' }}
                                    </option>
                                    @foreach ($Q_statuses as $q_status)
                                    <option value="{{ $q_status->name }}" {{ isset($request) &&
                                        $request->filter_Q_status == $q_status->name ? 'selected' :
                                        '' }}>
                                        {{ $q_status->name }}
                                    </option>
                                    @endforeach
                                ...
                                <div class="input-group">
                                    <select name="filter_last_updated" id="filter_last_updated"
                                        ...
                                        <option value="last_month" {{ isset($request) && $request->
                                            filter_last_updated == 'last_month' ? 'selected' : '' }}>
                                            Last Month
                                        </option>
                            ...
                            <table id="lead-table" class="table table-sm table-hover table-responsive w-100">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $item->name }}</td>
                                        <td>{{ $item->tel }} </td>
                                        <td class="d-none">{{ str_replace(' ', '', $item->tel) }}</td>
                                        <td class="d-none">{{ isset($item->campaign) ? $item->campaign->name : 'N/A' }}</td>
                                        ...
                                        @endif
                                        <td class="text-sm">
                                            {{ DB::table('followups')->where('lead_id', $item->id)->orderBy('id', 'desc')->select('remarks')->first()->remarks ?? '-' }}
                                        </td>
                                            ...
                                            <div class="d-flex align-items-center col-actions">
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end"
                                                        ...
                                                        <li><a  href="{{ route('lead.edit', $item->id) }}"
                                                                class="dropdown-item"><i
                                                                    class="bx bx-pencil font-size-16 text-secondary me-1"></i>
                                                                Edit Lead</a></li>
                                                        <li><a href="{{ route('lead.show', $item->id) }}"
                                                                class="dropdown-item"><i
                                                                    class="mdi mdi-eye-outline font-size-16 text-primary me-1"></i>
                                                                View Lead</a></li>
                                                        {{-- @if( $item->BOQ_number == NULL)     --}}
                                                            <li><a  href="{{ route('boq-create',$item->id ) }}"
                                                                class="dropdown-item"><i class="mdi mdi-plus font-size-16 text-success me-1"></i>
                                                                Create BOQ</a></li>
                                                        {{-- @endif         --}}
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('.dt-top-row').attr('style', 'display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;');
    });
</script>
