                                    ...
                                    <div class="col-sm-9">
                                        <select name="SupplierID" id="SupplierID" class="form-select select2 mt-5"   required="" style="width:100%;">
                                            ...
                                            <?php foreach ($supplier as $key => $value) : ?>
                                                <option value="{{$value->SupplierID}}" >{{$value->SupplierName}}</option> <?php endforeach ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <table >
                                    ...
                                    <tbody>
                                        <tr class="p-3" >
                                          ...
                                          <textarea name="Description[]" id="Description[]" rows="2" class="form-control mt-1 " style="width: 300px !important;"></textarea></td>
