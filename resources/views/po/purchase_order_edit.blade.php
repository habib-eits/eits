...
<h3>PURCHASE ORDER</h3>
            ...
            <form action="{{URL('/PurchaseOrderUpdate')}}" method="post" class="custom-validation">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="SupplierID" id="SupplierID" class="form-select select2 mt-5"   required="" style="width:100%;">
                                            <option value="">Select</option>
                                            <?php foreach ($supplier as $key => $value) : ?>
                                                <option value="{{$value->SupplierID}}" {{($value->SupplierID== $invoice_master[0]->SupplierID) ? 'selected=selected':'' }}>{{$value->SupplierName}}</option> <?php endforeach ?>
                                        </select>
                                    </div>
                                </div>
 ...
 <option value="TaxExclusive" {{($invoice_master[0]->TaxType=='TaxExclusive' ) ? 'selected=selected':'' }}>Tax Exclusive</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        <div class="col-sm-3">
                                            <label class="col-form-label text-danger" for="password">PO # </label>
                                        </div>
                                        <div class="col-sm-9">
                                ...
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        <div class="col-sm-3">
                                            <label class="col-form-label" for="email-id"> PO Date</label>
                                        </div>
                                        <div class="col-sm-9">
