                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="mb-1 row d-none">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="JobID" id="JobID" class="form-select select2 mt-5"   style="width:100%;">
                                            <option value="">Select</option>
                            ...
                            <div class="col-lg-4 col-12 ">
                                ...
                                <form class="form-inline">
                                    ...
                                    <div class="form-group mt-1">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text bg-light">{{session::get('Currency')}}</span>
                                            <input type="number" name="Total" id="Total" class="form-control" step="0.01" id="totalafterdisc"   placeholder="Total" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" value="{{$payment_plan->Amount}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mt-1">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text bg-light">{{session::get('Currency')}}</span>
                                            <input type="number" name="Grandtotal"  id="Grandtotal" class="form-control" step="0.01" id="grandtotal" placeholder="Grand Total"   onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" value="{{$payment_plan->Amount}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mt-1">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text bg-light">{{session::get('Currency')}}</span>
                                            <input type="number" class="form-control" name="PaymentPercentage" step="0.01" value="{{$payment_plan->PaymentPercentage}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mt-1">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text bg-light">{{session::get('Currency')}}</span>
                                            <input type="number" class="form-control" name="PaymentNo" id="PaymentNo" step="0.01" value="{{request()->paymentno}}">
                                        </div>
                                    </div>
