                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="PartyID" id="PartyID" class="form-select select2 mt-5"    style="width:100%;">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <div id="invoict_type"> <input type="text" name="InvoiceNo" autocomplete="off" id="InvoiceNo" class="form-control" ></div>
                                ...
                                <table >
                                    ...
                                    <tbody>
                                        <tr class="p-3" >
                                          ...
                                          <textarea name="Description[]" id="Description[]" rows="2" class="form-control mt-1 kashif " style="width: 300px !important;"></textarea></td>
                                        ...
                                        <label class="col-form-label" for="password">Salesperson </label>
                                          ...
                                          <input type="number" name="Gross[]" id="Gross_1" class=" form-control changesNo" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01">                                            </td>
                                            <td valign="top">
                                                <select name="Tax[]" id="TaxID_1"    class="form-select  changesNo tax exclusive_cal bg-light">
                                                    <?php foreach ($tax as $key => $valueX1) : ?>
                                                        <option value="{{$valueX1->TaxPer}}">{{$valueX1->Description}}</option>
                                                    <?php endforeach ?>
                                          </select>                                            </td>
