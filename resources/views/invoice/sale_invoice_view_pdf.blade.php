        ...
        <tr>
            <td valign="bottom" width="70%">
                 <div style="width: 200px;"> <strong>{{ $invoice_master[0]->PartyName }}</strong> <br>
                         ...
                         TRN#{{ $invoice_master[0]->TRN }}<br><br>
                        </div>
...
<?php      $no=0; ?>
               ...
               <tr valign="top" >
                   ...
                        @endforeach
                     ...
                     @else
                        ...
                        <li  style=" margin-top:8px;line-height:0.1%; margin-bottom: 8px; margin-left: 0px;list-style-type: afar; list-style-position: inside;padding-left: 20px; padding-top: 10px;">{{ $value->ItemName }}</li>
     ...
     <table width="100%">
         ...
         <tbody>
             <tr>
                 <td width="50%">  <div class="customer-notes">
                       <?php echo $invoice_master[0]->CustomerNotes; ?>
                    </div></td>
                 <td> <table class="noborder" width="100%" style="float: right; margin-top: 20px;">
                        <tfoot>
                            <tr class="cart_subtotal">
                                <td class="no-borders"></td>
                                <th class="description">Invoice Amount</th>
                        ...
                        <!--     <tr class="order_total">
                               ...
                               <tr class="order_total">
                                <td class="no-borders"></td>
                                <th class="description">{{$invoice_master[0]->PaymentPercentage}}%</th>
                                <td class="price"><span class="totals-price"><span
                            ...
                            <tr class="order_total">
                                <td class="no-borders"></td>
                                <th class="description">Due Amount</th>
                                <td class="price"><span class="totals-price"><span
                                            class="amount">{{ number_format($invoice_master[0]->Total, 2) }}</span></span>
                                </td>
                            </tr>
                               ...
                               <tr class="order_total">
                                ...
                                <th class="description">
                                  ...
                                  <?php
$paymentNumber = $invoice_master[0]->PaymentNo; // Example payment number, you can change this value to test different cases
