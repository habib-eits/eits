        ...
        <table id="quotation-table" width="733px" style="border: 1px solid black; border-collapse: collapse;margin-top:20px">
            <thead>
                <tr style="border: 1px solid black; border-collapse: collapse;">
                    <td colspan="6" style="background-color: #c9daf8;text-align:center; padding:10px; border-top:1px solid;border-left:1px solid;border-right:1px solid; margin-top:20px" >
