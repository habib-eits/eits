                ...
                <td style="width: 30%; text-align: right; padding-top: 20px; font-size: 18px; line-height: 1;">
                    <table style="width: 100%;">
                        ...
                        {{-- <tr>
                            ...
                            <td style="text-align: right; font-size:14px;color: #325da7;">{{ $receipt->EstimateNo }}</td>
                        </tr> --}}
                        <tr>
                            <th style="text-align: left;font-size:14px;color: #325da7;">Reference No:</th>
                            <td style="text-align: right;font-size:14px;color: #325da7;">{{ $receipt->InvoiceNo }}</td>
                        </tr>
                        <tr>
                            <th style="text-align: left;font-size:14px;color: #325da7;">Creation Date:</th>
                            <td style="text-align: right;font-size:14px;color: #325da7;">{{ date('d-M-Y', strtotime($receipt->date)) }}</td>
                        </tr>
                        {{-- @if($receipt->ExpiryDate)
                        <tr>
                            <th style="text-align: left;font-size:14px;color: #325da7;">Expiry Date:</th>
                            <td style="text-align: right;font-size:14px;color: #325da7;">{{ date('d-M-Y', strtotime($receipt->ExpiryDate)) }}</td>
                        </tr>
                        @endif --}}
        ...
        <tr >
            ...
            <div style="margin-top:10px;"></div>
                        <tr class="cart_subtotal">
                            ...
                            <td style="border-top:1px solid;padding-top:10px" class="price"><span class="totals-price"><span class="amount">
                                        {{ number_format($receipt->SubTotal, 2) }}</span></span>
                            </td>
                        </tr>
            ...
            @if($receipt->DiscountAmount > 0)
                <tr class="order_total">
                    ...
                    <td class="price"><span class="totals-price"><span
                                class="amount">{{ number_format($receipt->DiscountAmount, 2) }}</span></span>
                    </td>
                </tr>
            @endif
            <tr class="order_total">
                ...
                <td class="price"><span class="totals-price"><span
                            class="amount">{{ number_format($receipt->Total, 2) }}</span></span>
                </td>
            ...
            <tr class="order_total">
                ...
                <th class="description">Tax <span
                        style="font-size: 10px;">({{ substr($receipt->TaxType, 3, 10) }})</span>
                </th>
                <td class="price"><span class="totals-price"><span
                            class="amount">{{ number_format($receipt->Tax, 2) }}</span></span>
                </td>
            </tr>
            ...
            <tr class="order_total">
                ...
                <td class="price"><span class="totals-price"><span
                            class="amount">{{ number_format($receipt->GrandTotal, 2) }}</span></span>
                </td>
            </tr>
            ...
            <tr class="order_total">
                ...
                <td class="price" style="color:green"><span class="totals-price"><span
                            class="amount">{{ number_format($receipt->Paid, 2) }}</span></span>
                </td>
            </tr>
            <tr class="order_total">
                <td class="no-borders"></td>
                ...
                <td class="price " style="color:red"><span class="totals-price"><span
                            class="amount "><b>{{ number_format($receipt->GrandTotal - $receipt->Paid, 2) }}</b></span></span>
                </td>
            </tr>
