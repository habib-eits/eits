            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{URL('/UserUpdate')}}" method="post">
                        ...
                        <input type="hidden" name="id" value="{{$v_users[0]->id}}">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <select name="UserType" class="form-select">
                                    ...
                                    <option value="Admin" {{($v_users[0]->UserType == 'Admin' ) ? 'selected=selected':''
                                        }}>Admin</option>
                                    <option value="Agent" {{($v_users[0]->UserType == 'Agent' ) ? 'selected=selected':''
                                        }}>Agent</option>
                                    <option value="User" {{($v_users[0]->UserType == 'User' ) ? 'selected=selected':''
                                        }}>User</option>
                            ...
                            <div class="col-md-10" >
                              <select  name="branch_id" id="branch_id" class="form-control" required>
                                ...
                                @foreach ($branches as $item)
                                    <option value="{{ $item->id }}" {{ $item->id == $v_users[0]->branch_id ? 'selected' : '' }}> {{ $item->name }}</option>
                                @endforeach
                            </select>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <select name="Active" class="form-select">
                                    ...
                                    <option value="Yes" {{($v_users[0]->Active == 'Yes' ) ? 'selected=selected':''
                                        }}>Yes</option>
                                    <option value="No" {{($v_users[0]->Active == 'No' ) ? 'selected=selected':'' }}>No
                                    </option>
