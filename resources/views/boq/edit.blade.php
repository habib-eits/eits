...
@section('content')
    ...
    <div class="main-content">
        <div class="page-content">
            <div class="container-fluid">
                ...
                <form action="{{ route('boq.update', $estimate_master[0]->EstimateMasterID) }}" method="post"
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                        ...
                                        <div class="col-sm-9">
                                            @php
                                                $party = DB::table('party')
                                                    ->where('PartyID', $estimate_master[0]->PartyID)
                                                    ->first();
                                    ...
                                    <div class="mb-1 row d-none" id="WalkinCustomer">
                                        <div class="col-sm-3">
                                            <label class="col-form-label" for="password">Walkin Customer
                                            </label>
                                        </div>
                                        <div class="col-sm-9">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="TaxType" id="TaxType" class="form-select">
                                                ...
                                                <option value="TaxInclusive"
                                                    {{ $estimate_master[0]->TaxType == 'TaxInclusive' ? 'selected=selected' : '' }}>
                                                    Tax Inclusive</option>
                                                <option value="TaxExclusive"
                                                    {{ $estimate_master[0]->TaxType == 'TaxExclusive' ? 'selected=selected' : '' }}>
                                        ...
                                        <div class="col-sm-9">
                                                <select name="state" id="" class="form-select" required>
                                                    <option value="">Choose</option>
                                                        ...
                                                        <option @if($estimate_master[0]->state  == $state->name)       selected @endif value="{{ $state->name }}">{{ $state->name }}</option>
                                                            
                                                        @endforeach

                                                            {{-- <option @if($estimate_master[0]->state  == "Abu Dhabi")       selected @endif value="Abu Dhabi">Abu Dhabi</option>
                                                            <option  @if($estimate_master[0]->state  == "Dubai")          selected @endif value="Dubai">Dubai</option>
                                                            <option  @if($estimate_master[0]->state  == "Sharjah")        selected @endif value="Sharjah">Sharjah</option>
                                                            <option  @if($estimate_master[0]->state  == "Ajman")          selected @endif value="Ajman">Ajman</option>
                                                            <option  @if($estimate_master[0]->state  == "Umm Al-Quwain")  selected @endif value="Umm Al-Quwain">Umm Al-Quwain</option>
                                                            <option  @if($estimate_master[0]->state  == "Fujairah")       selected @endif value="Fujairah">Fujairah</option>
                                                            <option  @if($estimate_master[0]->state  == "Ras Al Khaimah") selected @endif value="Ras Al Khaimah">Ras Al Khaimah </option>
                                                            <option  @if($estimate_master[0]->state  == "Pakistan")       selected @endif value="Pakistan">Pakistan </option>
                                                            <option  @if($estimate_master[0]->state  == "Qatar") selected @endif value="Qatar">Qatar </option>
                                                            <option  @if($estimate_master[0]->state  == "Saudi Arabia") selected @endif value="Saudi Arabia">Saudi Arabia </option> --}}
                                                </select>
                                    ...
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="location"  class="form-control" value="{{ $estimate_master[0]->location }}">
                                        </div>
                                                ...
                                                <div class="col-sm-9">
                                                    <select name="BranchID" id="BranchID" class="form-select">
                                                        ...
                                                        <option value="{{ $value->BranchID }}"
                                                            {{ $value->BranchID == $estimate_master[0]->BranchID ? 'selected=selected' : '' }}>
                                        ...
                                        <div class="mb-1 row">
                                            ...
                                            <div class="col-sm-9">
                                                <div id="invoict_type"> <input type="text" name="EstimateNo"
                                                        ...
                                                        required="" value="{{ $estimate_master[0]->EstimateNo }}"
                                                        readonly>
                                                </div>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($estimate_detail as $key => $value1)
                                                ...
                                                <tr class="p-3">
                                                    ...
                                                    <td valign="top">
                                                        <select required name="services_id[]" id="services_id_{{ $no }}"
                                                            class="item form-select  form-control-sm select2 "
                                                            style="width: 300px !important; margin-bottom: 5px;">
                                                            <option value="">select</option>
                                                            @foreach ($services as $key => $value)
                                                                <option @if ($value->id == $value1->services_id) selected @endif
                                                                    value="{{ $value->id }}">
                                                                    {{ $value->name }}</option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <td valign="top">
                                                        <input type="number" name="unit_net_cost[]" id="unit_net_cost[]"
                                                            class=" form-control unit-net-cost" step="0.01"
                                                            value="{{ $value1->unit_net_cost }}" autocomplete="off">
                                                    </td>
                                                    <td valign="top">
                                                        <input type="number" name="vat_per_unit[]" id="vat_per_unit[]"
                                                            class=" form-control vat-per-unit" step="0.01"
                                                            value="{{ $value1->vat_per_unit }}" readonly>
                                                    </td>
                                                    <td valign="top">
                                                        <input type="number" name="unit_with_vat[]" id="unit_with_vat[]"
                                                            class=" form-control unit-with-vat" step="0.01" readonly
                                                            value="{{ $value1->unit_with_vat }}">
                                                    </td>
                                                    <td valign="top">
                                                        <input type="number" name="per_unit_profit_margin[]"
                                                            id="per_unit_profit_margin[]"
                                                            class=" form-control per-unit-profit-margin" step="0.01"
                                                            value="{{ $value1->per_unit_profit_margin }}" readonly>
                                                    </td>

                                                    <td valign="top">
                                                        <input type="number" name="per_unit_selling_price[]"
                                                            id="per_unit_selling_price[]"
                                                            class=" form-control per-unit-selling-price" step="0.01"
                                                            value="{{ $value1->per_unit_selling_price }}"
                                                            autocomplete="off">
                                                    </td>
                                                    ...
                                                    <td valign="top">
                                                        <div class="d-flex">
                                                            <input type="number" name="quantity[]" id="quantity[]"
                                                                class="form-control quantity ms-1 me-1" step="0.01"
                                                                value="{{ $value1->Qty }}">
                                                            <select class="form-select me-1" name="LS[]"
                                                                id="LS">
                                                                <option @if ($value1->LS == 'NO') selected @endif
                                                                    value="NO"><small>LS / NO</small></option>
                                                                <option @if ($value1->LS == 'YES') selected @endif
                                                                    value="YES"><small>L/S YES</small></option>
                                                            </select>
                                                        </div>
                                                    </td>

                                                    <td valign="top">
                                                        <input type="number" name="total_cost_with_vat[]"
                                                            id="total_cost_with_vat[]"
                                                            class=" form-control total-cost-with-vat" step="0.01"
                                                            value="{{ $value1->total_cost_with_vat }}" readonly>
                                                    </td>
                                                    <td valign="top">
                                                        <input type="number" name="total_profit_margin[]"
                                                            id="total_profit_margin[]"
                                                            class=" form-control total-profit-margin" step="0.01"
                                                            value="{{ $value1->total_profit_margin }}" readonly>
                                                    </td>
                                                    <td valign="top">
                                                        <input type="number" name="item_total[]" id="item_total[]"
                                                            class=" form-control item-total" step="0.01"
                                                            value="{{ $value1->item_total }}" readonly>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td valign="top"></td>
                                                    ...
                                                    <td  colspan="2" valign="top">
                                                        <textarea  placeholder="Description for engg"  name="DescriptionDetail[]" id="DescriptionDetail[]" rows="2" class="form-control mt-1 kashif kashif "
                                                            style="width: 300px !important;">{{ $value1->DescriptionDetail }}</textarea>
                                                    </td>
                                                    <td></td>
                                                    <td colspan="2" valign="top">
                                                    ...
                                                    <td colspan="1" class="text-end">     
                                                            ...
                                                            <img  class=" mt-3 item-old-image {{ $value1->image ? '': 'd-none' }}" src="{{ asset('boq-images/'. $value1->image) }}" alt="" width="50px" height="35px">

                                                            <input type="hidden" name="old_image[]" class="item-old-image-value" value="{{ $value1->image }}">
                                                       
                                                    </td>
                                                    
                                                    <td class=" ">
                                                        <button type="button" class="{{ $value1->image ? '': 'd-none' }} btn btn-warning mt-3 mx-3 item-remove-btn"> <span class="fa fa-close" ></span> </button>
                                                    </td>
                            ...
                            <div class="row mt-1 mb-2" style="margin-left: 55px;">
                                <div class='col-xs-5 col-sm-3 col-md-3 col-lg-3  '>
                                    <button onclick="appendRowsTotableBOQ()" class="btn btn-success addmore"
                                        type="button"><i class="bx bx-list-plus align-middle font-medium-3 me-25"></i>
                                        Add More</button>
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-lg-6">
                                    <textarea class="form-control editme" rows="50" cols="50" name="CustomerNotes" id="notes"
                                    ...
                                    <div class="form-inline">
                                        <div class="form-group mt-1">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" class="form-control" id="material_cost"
                                                    name="material_cost" placeholder="material Cost" step="0.01"
                                                    value="{{ $estimate_master[0]->material_cost }}" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group mt-1">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input onchange="summaryCalculation()" type="number"
                                                    class="form-control" id="labour_cost" name="labour_cost"
                                                    placeholder="labour Cost" step="0.01"
                                                    value="{{ $estimate_master[0]->labour_cost }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group mt-1">
                                            ...
                                            <div class="input-group">
                                                <span
                                                    class="input-group-text bg-light">{{ session::get('Currency') }}</span>
                                                <input onchange="summaryCalculation()" type="number"
                                                    class="form-control" id="transport_cost" name="transport_cost"
                                                    placeholder="Transport Cost" step="0.01"
                                                    value="{{ $estimate_master[0]->transport_cost }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group mt-1">
                                            ...
                                            <div class="input-group">
                                                <span
                                                    class="input-group-text bg-light">{{ session::get('Currency') }}</span>
                                                <input onchange="summaryCalculation()" type="number"
                                                    class="form-control" id="material_delivery_cost"
                                                    name="material_delivery_cost" placeholder="material_delivery_cost"
                                                    step="0.01"
                                                    value="{{ $estimate_master[0]->material_delivery_cost }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group mt-1">
                                            ...
                                            <div class="input-group">
                                                <span
                                                    class="input-group-text bg-light">{{ session::get('Currency') }}</span>
                                                <input onchange="summaryCalculation()" type="number"
                                                    class="form-control" id="project_cost" name="project_cost"
                                                    placeholder="Project Cost" step="0.01"
                                                    value="{{ $estimate_master[0]->project_cost }}" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group mt-1">
                                            <label>Margin: &nbsp;</label>
                                            <div class="input-group">
                                                ...
                                                <input onchange="summaryCalculation()" type="number" value="{{ $estimate_master[0]->total_margin }}" class="form-control" id="total_margin" name="total_margin" placeholder="" step="0.01" readonly>
                                        ...
                                        <div class="form-group mt-1">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="subtotal"
                                                    name="subtotal" value="{{ $estimate_master[0]->SubTotal }}"
                                                    placeholder="Item Subtotal" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group mt-1">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input onchange="summaryCalculation()" type="number"
                                                    ...
                                                    value="{{ $estimate_master[0]->Discount }}" placeholder="Discount" step="0.01">
                                            </div>
                                        </div>
                                        <div class="form-group mt-1">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input onchange="summaryCalculation()" type="number"
                                                    ...
                                                    value="{{ $estimate_master[0]->Total }}" placeholder="total_amount"
                                                    readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group mt-1">
                                            ...
                                            <div class="input-group">
                                                <span
                                                    class="input-group-text bg-light">{{ session::get('Currency') }}</span>
                                                <input onchange="summaryCalculation()" type="number"
                                                    class="form-control" id="incl_vat_total_amount"
                                                    name="incl_vat_total_amount" value="{{ $estimate_master[0]->Tax }}"
                                                    placeholder="5% VAT on Total Amount" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group mt-1">
                                            ...
                                            <div class="input-group">
                                                <span
                                                    class="input-group-text bg-light">{{ session::get('Currency') }}</span>
                                                <input onchange="summaryCalculation()" type="number"
                                                    class="form-control" id="grand_total" name="grand_total"
                                                    value="{{ $estimate_master[0]->GrandTotal }}"
    ...
    <script>
        ...
        $('#BOQ-table').on('click', '.item-remove-btn', function() {
            ...
            if (confirm('Are you sure you want to remove this image?')) {
                ...
                var imageValue = row.find('.item-old-image-value');
                imageValue.val('');
                var image = row.find('.item-old-image');
                image.attr('src', '').addClass('d-none');
    
                var btn = row.find('.item-remove-btn');
                btn.addClass('d-none');
            }
        });
    </script>
    ...
    <script>
        ...
        //     });
        //     $('#materialCost').val(materialCost.toFixed(2));
        ...
        function appendRowsTotableBOQ() {
            ...
            <tr>
                ...
                <td colspan="2" valign="top">
                    <input class="form-control mt-3" type="file" name="image[]">
                    <input type="hidden" name="old_image[]" class="item-old-image-value" value="">
