...
<head>
    ...
    <title>{{ 'BOQ - '.$estimate[0]->ReferenceNo . ' - '. $party->PartyName  }}</title>
                ...
                <tr>
                    ...
                    <td style="width: 30%; text-align: right; padding-top: 20px; font-size: 18px; line-height: 1;">
                        <table style="width: 100%;">
                            <tr >
                                <th style="text-align: right;font-size:24px;color: #163263;" colspan="2">BOQ</th>
                            </tr>
                            
                            <tr>
                                <th style="text-align: left; font-size:12px;color: #325da7;">BOQ No:</th>
                                <td style="text-align: right; font-size:12px;color: #325da7;">{{ $estimate[0]->EstimateNo }}</td>
                            </tr>
                            <tr>
                                <th style="text-align: left;font-size:12px;color: #325da7;">Reference No:</th>
                                <td style="text-align: right;font-size:12px;color: #325da7;">{{ $estimate[0]->ReferenceNo }}</td>
                            </tr>
                            <tr>
                                <th style="text-align: left;font-size:12px;color: #325da7;">Creation Date:</th>
                                <td style="text-align: right;font-size:12px;color: #325da7;">{{ date('d-M-Y', strtotime($estimate[0]->Date)) }}</td>
                            </tr>
                            <tr>
                                <th style="text-align: left;font-size:12px;color: #325da7;">Expiry Date:</th>
                                <td style="text-align: right;font-size:12px;color: #325da7;">{{ date('d-M-Y', strtotime($estimate[0]->ExpiryDate)) }}</td>
                            </tr>
...
<br>
        ...
        <tr>
            ...
            <td width="45%" style="border: 1px solid black; ">
                <table width="100%" style="border-collapse: collapse;">
                    ...
                    <tr>
                        <th style="text-align: left; font-size: 14px; padding: 10px 10px 0px 10px;width: 20%;">TRN:</th>
                        <td style="text-align: left; font-size: 14px; padding: 10px 10px 0px 10px;width: 80%;">{{ $party->TRN}}</td>
                    </tr>
                    @endif
                    @if($party->Mobile)
                    <tr>
    ...
    @foreach ($services as $service)
        @php
            ...
            $estimate_details = DB::table('v_estimate_detail')
                ->where('EstimateMasterID', request()->EstimateMasterID)
        ...
        <table width="733px" style=" border: 1px solid black; border-collapse: collapse;margin-top:20px">
            <thead>
                <tr style="border: 1px solid black; border-collapse: collapse;">
                    <td style="background-color: #c9daf8;text-align:center; padding:10px; border-top:1px solid;border-left:1px solid;border-right:1px solid; margin-top:20px" colspan="11">
                        <b>{{ strtoupper($service->name) }}</b>
                    </td>
                </tr>
                <tr style="background-color: #f1f1f1; border-bottom: 1px solid;">
                    <th style="vertical-align: middle; text-align:left;" class="table-th" >#</th>
                    <th  style="vertical-align: middle; text-align:left; padding-left:5px" class="product table-th" >Description</th>
                  
                    <th width="10%" style="text-align:center" class="table-th">Unit <br> Cost</th>
                    <th width="10%" style="text-align:center" class="table-th">VAT <br> per Unit</th>
                    <th width="10%" style="text-align:center" class="table-th">Unit Cost <br> <small>(incl. VAT)</small></th>
                    <th width="10%" style="text-align:center" class="table-th">Unit <br> Margin</th>
                    <th width="10%" style="text-align:center" class="table-th">Selling <br> Price</th>
                    <th width="10%" style="text-align:center" class="table-th">Quantity</th>
                    <th width="10%" style="text-align:center" class="table-th">Total <br> Cost</th>
                    <th width="10%" style="text-align:center" class="table-th">Total <br> Margin</th>
                    <th width="15%" style="text-align:center" class="table-th">Total <br> Price</th>
                </tr>
            </thead>
            ...
            <tbody>
                ...
                @foreach ($estimate_details as $key => $value)
                    ...
                    <tr valign="top">
                        ...
                        <td class="table-td " style="text-align: left; padding-left:5px" > 
                            
                            <div>
                                {!! nl2br(e($value->Description)) !!}
                            </div>
                            @if($value->DescriptionDetail != NULL)
                        ...
                        <td class="table-td"> 
                            <li class="table-li"> {{ $value->unit_net_cost == 0 ? '-' : number_format($value->unit_net_cost, 2) }}</li>
                        </td>
                        <td class="table-td"> 
                            <li class="table-li">{{ $value->vat_per_unit == 0 ? '-' : number_format($value->vat_per_unit, 2) }} </li>
                            
                        </td>
                        <td class="table-td"> 
                            <li class="table-li">{{ $value->unit_with_vat == 0 ? '-' : number_format($value->unit_with_vat, 2) }} </li> 
                        </td>
                        <td class="table-td"> 
                            <li class="table-li">{{ $value->per_unit_profit_margin == 0 ? '-' : number_format($value->per_unit_profit_margin, 2) }}</li>
                        ...
                        <td class="table-td">
                            <li class="table-li" > {{ $value->total_cost_with_vat == 0 ? '-' : number_format($value->total_cost_with_vat, 2) }}</li>
                           

                        </td>
                        <td class="table-td">
           
                            <li class="table-li" > {{ $value->total_profit_margin == 0 ? '-' : number_format($value->total_profit_margin, 2) }}</li>
                ...
                <tr style="border-top: 1px solid;background-color: #f1f1f1;">
                    ...
                    <td colspan="10" style="text-align: center; border-right:1px solid;"><b>Total</b></td>
    ...
    <table  width="735px" style="margin-top: 20px">
        <tr>
            <td style="vertical-align: bottom" width="500px" >
                <table > 
                    <tr class="cart_subtotal">
                        <td class="no-borders"></td>
                        <th class="description">Material Cost: </th>
                        <td class="price"><span class="totals-price"><span class="amount">
                                    {{ number_format($estimate[0]->material_cost, 2) }}</span></span>
                        </td>
                    </tr> 
                    <tr class="order_total">
                        <td class="no-borders"></td>
                        <th class="description">Labour Cost:  </th>
                        <td class="price"><span class="totals-price"><span
                                    class="amount">{{ number_format($estimate[0]->labour_cost, 2) }}</span></span>
                        </td>
                    </tr>
        
                    <tr class="order_total">
                        <td class="no-borders"></td>
                        <th class="description">Transport Cost:  </th>
                        <td class="price"><span class="totals-price"><span
                                    class="amount">{{ number_format($estimate[0]->transport_cost, 2) }}</span></span>
                        </td>
                    </tr>
                    <tr class="order_total">
                        <td class="no-borders"></td>
                        <th class="description">Material Delivery Cost:  </th>
                        <td class="price"><span class="totals-price"><span
                                    class="amount">{{ number_format($estimate[0]->material_delivery_cost, 2) }}</span></span>
                        </td>
                    </tr>
                    <tr class="order_total">
                        <td class="no-borders"></td>
                        <th class="description">Project Cost:  </th>
                        <td class="price"><span class="totals-price"><span
                                    class="amount">{{ number_format($estimate[0]->project_cost, 2) }}</span></span>
                        </td>
                    </tr>
                    <tr class="order_total">
                        <td class="no-borders"></td>
                        <th class="description">Total Margin After Discount:  </th>
                        <td class="price"><span class="totals-price">
                            <span class="amount">{{ number_format($estimate[0]->total_margin, 2) }}</span>
                        </td>
                    </tr>
                    <tr class="order_total">
                        <td class="no-borders"></td>
                        <th class="description">Percentage Margin  </th>
                        <td class="price"><span class="totals-price"><span
                                    class="amount">{{ number_format(($estimate[0]->total_margin/$estimate[0]->SubTotal)*100, 2) }}%</span></span>
                        </td>
                    </tr>
