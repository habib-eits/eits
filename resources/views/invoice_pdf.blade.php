            ...
            <tr>
                ...
                <td style="width: 30%; text-align: right; padding-top: 20px; font-size: 18px; line-height: 1;">
                    <table style="width: 100%;">
                        <tr >
                            <th style="text-align: right;font-size:24px;color: #163263;padding-bottom:10px" colspan="2">Tax Invoice</th>
                        </tr>
                        {{-- <tr>
                        ...
                        @php
                            $invoiceNo = $invoice_mst[0]->InvoiceNo;
                            $updatedInvoiceNo = preg_replace('/^EITS-/', 'INV-', $invoiceNo);
                        @endphp
                        <tr>
                            <th style="text-align: left;font-size:14px;color: #325da7;">Invoice No:</th>
                            <td style="text-align: left;font-size:14px;color: #325da7;">{{ $updatedInvoiceNo }}</td>
                            {{-- <td colspan="2" style="text-align: right;font-size:16px;color: #325da7; padding-bottom:5px">{{ $updatedInvoiceNo }}</td> --}}
        ...
        <tr>
            {{-- <td style="width:45%">
                <table>
                    ...
                    <tr>
                        <td>EXTENSIVE IT SERVICES</td>
                    </tr>
                    <tr>
                        <td>Bank Name: Mashreq Bank</td>
                    </tr>
                    <tr>
                        <td>Account No: 019100879199</td>
                    </tr>
                    <tr>
                        <td>IBAN: AE280330000019100879199</td>
                    </tr>
                </table>
            </td> --}}
            ...
            <td style="width:45%">
                <table>
                    ...
                    <tr>
                        <td>Bank Name: ADCB </td>
                    </tr>
                    <tr>
                        <td>Account No: 12323776920001</td>
                    </tr>
                    <tr>
                        <td>IBAN: AE260030012323776920001</td>
                    </tr>
                </table>
            </td>
        </tr>
