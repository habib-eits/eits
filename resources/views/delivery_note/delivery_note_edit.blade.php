...
<h3>DELIVERY NOTE</h3>
            ...
            <form action="{{URL('/DeliveryChallanUpdate')}}" method="post" class="custom-validation">
...
<script>
     var i = $('table tr').length;
                                ...
                                <table >
                                    <thead>
                                        <tr class=" borde-1 border-light " style="height: 40px;">
                                            <th width="3%"  align="center"><input id="check_all" type="checkbox" /></th>
                                            ...
                                            <th width="4%"  class="d-none" >Value for Tax</th>
                                            <th width="4%" class="d-none">Tax</th>
                                            <th width="4%" class="d-none">Tax Val</th>

                                            <th width="4%" class="d-none">AMOUNT</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <tr class="p-3" >
                                          ...
                                          <td valign="top">
                                                ...
                                                <select name="ItemID0[]" id="ItemID0_1" class="item form-select  form-control-sm select2   changesNoo " onchange="km(this.value,1);" style="width: 800px !important;">
                                                    <option value="">select</option>
                                          ...
                                          <textarea name="Description[]" id="Description[]" rows="2" class="form-control mt-1 d-none " style="width: 300px !important;">{{$value1->Description}}</textarea></td>
                        ...
                        <div class="row mt-4 ">
                              ...
                              <div class="col-md-4">
                            <div class="mb-3">
                            <label for="basicpill-firstname-input">Driver Name *</label>
                            <input type="text" class="form-control" name="DriverName" value="{{$invoice_master[0]->DriverName}} ">
                            </div>
                            </div>

                              <div class="col-md-4">
                            <div class="mb-3">
                            <label for="basicpill-firstname-input">Driver Contact *</label>
                            <input type="text" class="form-control" name="DriverContact" value="{{$invoice_master[0]->DriverContact}} ">
                            </div>
                            </div>
                              ...
                              <div class="col-md-4">
                            <div class="mb-3">
                            <label for="basicpill-firstname-input">Vehicle No *</label>
                            <input type="text" class="form-control" name="VehicleNumber" value="{{$invoice_master[0]->VehicleNumber}} ">
                            </div>
                            </div>
...
html += '<td valign="top" class="d-none"> <input type="number" name="UnitQty[]" id="UnitQty_'+ i + '" class=" form-control changesNo " autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" value="">                                            </td>';
         ...
         html += '<td valign="top"><input type="text" name="Qty[]" id="Qty_' + i + '" class="form-control changesNo QtyTotal" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" value="1"> <select  class="form-select mt-1 d-none" name="LS[]" id="LS_' + i + '"><option value="YES"> L/S YES</option>        <option value="NO">LS / NO</option>    </select></td>';

        html += '<td valign="top" class="d-none"><input type="text" name="Price[]" id="Price_' + i + '" class="form-control changesNo " autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"></td>';
        ...
        html += '<td  valign="top" class="d-none"> <input type="number" name="Gross[]" id="Gross_' + i + '" class=" form-control changesNo" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01">  </td>';

        html += '<td  valign="top" class="d-none"><select name="Tax[]" id="TaxID_' + i + '" class="form-control changesNo exclusive_cal bg-light"><?php foreach ($tax as $key => $valueX1) : ?><option value="{{$valueX1->TaxPer}}">{{$valueX1->Description}}</option><?php endforeach ?></select></td>';


        html += '<td  valign="top" class="d-none"><input type="number" name="TaxVal[]" id="TaxVal_' + i + '" class=" form-control totalLinePrice2 "autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" value="0"></td>';




        html += '<td  valign="top" class="d-none"><input type="text" name="ItemTotal[]" id="ItemTotal_' + i + '" class="form-control totalLinePrice" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"></td>';
