...
<script>
     var i = $('table tr').length;
                                    ...
                                    <tbody>
                                        <tr class="p-3" >
                                          ...
                                          <td valign="top">
                                                ...
                                                <select name="ItemID0[]" id="ItemID0_1" class="item form-select  form-control-sm select2   changesNoo " onchange="km(this.value,1);" style="width: 100% !important;">
                                                    <option value="">select</option>
                                          ...
                                          <textarea name="Description[]" id="Description[]" rows="2" class="form-control mt-1 d-none " style="width: 300px !important;"></textarea></td>
                                          ...
                                          <input type="number" name="UnitQty[]" id="UnitQty_1" class=" form-control changesNo  " autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" value="">                                            </td>
                                             ...
                                             <td valign="top">
                                          <input type="number" name="Qty[]" id="Qty_1" class=" form-control changesNo QtyTotal" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" value="1">           <select  class="form-select mt-1 d-none" name="LS[]" id="LS_1"><option value="YES"> L/S YES</option>        <option value="NO">LS / NO</option>    </select>                                   </td>
                        ...
                        <div class="row mt-4 ">
                            ...
                            <input type="text" class="form-control" name="DriverContact" value="{{old('DriverContact')}} ">
                            </div>
                            </div>
                            ...
                            <input type="text" class="form-control" name="VehicleNumber" value="{{old('VehicleNumber')}} ">
                            </div>
                            </div>
