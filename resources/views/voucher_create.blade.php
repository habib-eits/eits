                    ...
                    <table   style="border-collapse: collapse;" cellspacing="0" cellpadding="0">
                      ...
                      <tbody>
                        <tr  class="bg-light border-1 border-light" >
                          ...
                          <td> <select name="SupplierID[]" id="SupplierID_1" class="  select2 form-select " onchange="ajax_balance(this.value);" style="width: 240px !important;">
                        ...
                        <td> <select name="PartyID[]" id="PartyID_1" class="  select2 form-select " onchange="ajax_balance(this.value);" style="width: 240px !important;">
...
html += '<td><select name="SupplierID[]" id="SupplierID_'+i+'"  onchange="ajax_balance(this.value);" class="form-select select2" style="width: 240px !important;"> <option value="">Select Supplier</option>@foreach ($supplier as $key => $value) <option value="{{$value->SupplierID}}">{{$value->SupplierName}}</option>@endforeach</select></td>';

html += '<td><select name="PartyID[]" id="PartyID_'+i+'" class="form-select select2" onchange="ajax_balance(this.value);" style="width: 240px !important;"><option value="">Select PartyID</option>@foreach ($party as $key => $value)<option value="{{$value->PartyID}}">{{$value->PartyName}}</option>@endforeach</select></td>';
