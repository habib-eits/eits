        ...
        <tr>
            <td colspan="2" class="header">
                <div align="center">
                    ...
                    <h3 style="margin-top: 4px;"><u>CUSTOMER COPY</u></h3>
                </div>
            </td>
        </tr>
    </table>
    <table class="order-data-addresses">
        <tr>
            <td valign="bottom" class="address billing-address">
                ...
                <span>Client: {{ $invoice_master[0]->PartyName }}
                    {{ $invoice_master[0]->WalkinCustomerName == 1 ? ' -' . $invoice_master[0]->WalkinCustomerName : '' }}</span><br />
                @if ($invoice_master[0]->PartyID != 1)
                    Contact: {{ $invoice_master[0]->Phone }}<br />
                    Email: {{ $invoice_master[0]->Email }}<br />
            ...
            <td class="order-data">
                <table align="right">
                    ...
                    <tr class="payment-method">
                        ...
                        <td>
                            <div align="right">{{ dateformatman($invoice_master[0]->DueDate) }}</div>
                        </td>
                    </tr>
                    <tr class="payment-method">
                        <th><span>Ref(L.P.O)#: </span></th>
                        <td>
                    ...
                    <tr class="payment-method">
                        ...
                        <td>
                            <div align="right">
                                {{ $invoice_master[0]->PaymentMode }}-{{ $invoice_master[0]->PaymentDetails }}</div>
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td colspan="2" valign="bottom" class="billing-address address"><strong>Subject :
                </strong>{{ $invoice_master[0]->Subject }}</td>
        </tr>
    </table>
    <table class="order-details">
        ...
        <tbody>
            ...
            @foreach ($invoice_detail as $key => $value)
                ...
                <tr>
            @endforeach
            <?php  for($i = 5; $i>=count($invoice_detail);$i--) { ?>
            ...
            <tr class="no-borders">
                <td colspan="3" class="no-borders">
                    <div class="customer-notes"><strong>Total Quantity</strong> : {{ $Qty }} <br><Br>
                        <strong>Item Discount</strong> : {{ number_format($Discount) }}
                    </div>
                    ...
                    <div class="customer-notes"><strong>Description Notes: </strong><br><br>
                        @php
                            $liness = explode("\n", $invoice_master[0]->DescriptionNotes);
                    ...
                    <div style="padding-top: 10px;"><strong style="text-decoration: underline">Bank Details </strong>:
                        <br><br>
                        <span>AL SUHOOR TECHINCAL SERVICES CO.LLC</span><br>
                        <span>A/C No: 13182451920001</span><br>
                        <span>IBAN: AE280030013182451920001</span><br>
                        <span>SWIFT CODE: ADCBAEAA</span><br>
                        <span>Bank Name: ADCB</span>
        ...
        <tr>
            <td colspan="2" class="header">
                <div align="center">
                    <h2><u>{{ strtoupper($invoice_master[0]->InvoiceType) }}</u></h2>
                    <h3 style="margin-top: 3px;"><u>TRN: {{ $company[0]->TRN }}</u></h3>
                    <h3 style="margin-top: 4px;"><u>OFFICE COPY</u></h3>
                </div>
            </td>
        </tr>
    </table>
