                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <label for="basicpill-firstname-input">Booking Date *</label>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <label for="basicpill-firstname-input">End Date * <span class="text-primary" >By enteirng end date it will close the booking</span></label>
                                            ...
                                            <select name="user_id" id="user_id" class="form-select select2"
                                                ...
                                                @foreach ($user as $value)
                                                    <option value="{{ $value->id }}"
                                                        {{ $value->id == $leads[0]->agent_id ? 'selected=selected' : '' }}>
                                                        {{ $value->name }}</option>
                                                @endforeach
                                            ...
                                            <select name="PartyID" id="PartyID" class="form-select select2"
                                                ...
                                                @foreach ($party as $value)
                                                    <option value="{{ $value->PartyID }}"
                                                        {{ $value->PartyID == $leads[0]->partyid ? 'selected=selected' : '' }}
                                                        data-contact="1" data-address="2">{{ $value->PartyName }}</option>
                                                @endforeach
                                            ...
                                            <select name="PartyID" id="PartyID" class="form-select select2"
                                                ...
                                                @foreach ($party as $value)
                                                    <option value="{{ $value->PartyID }}"
                                                        ...
                                                        data-address="{{ $value->Address }}">{{ $value->PartyName }}
                                                    </option>
                                                @endforeach
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="client_contact"
                                            id="client_contact" value="{{ count($leads) > 0 ? $leads[0]->tel : '' }} " readonly>
                                ...
                                <div class="col-md-4 d-none">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="client_address"
                                            id="client_address"
                                            value="{{ count($leads) > 0 ? $leads[0]->business_details : '' }}" readonly>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="SupplierID" id="SupplierID" class="form-select select2">
                                            ...
                                            @foreach ($supplier as $value)
                                                <option value="{{ $value->SupplierID }}">{{ $value->SupplierName }}
                                                </option>
                                            @endforeach
