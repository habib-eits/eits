            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            ...
                            <h4 class="mb-sm-0 font-size-18">booking Edit</h4>
                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ URL('/BookingUpdate1') }}" id="bookingUpdateForm" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control colors" id="colorSelect" name="Color"
                                            style="width: 100%">

                                            <option value="black"
                                                {{ 'black' == $booking[0]->color ? 'selected=selected' : '' }}></option>
...
"></option>
                                        ...
                                        <select name="user_id" id="user_id" class="form-select select2">
                                            ...
                                            @foreach ($user as $value)
                                                <option value="{{ $value->id }}"
                                                    {{ $value->id == $booking[0]->users_id ? 'selected=selected' : '' }}>
                                                    {{ $value->name }}</option>
                                            @endforeach
                                        ...
                                        <select name="PartyID" id="PartyID" class="form-select select2">
                                            ...
                                            @foreach ($party as $value)
                                                <option value="{{ $value->PartyID }}"
                                                    {{ $value->PartyID == $booking[0]->PartyID ? 'selected=selected' : '' }}>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" readonly class="form-control" name="client_contact"
                                            value="{{ $booking[0]->client_contact }}">
                                ...
                                <div class="col-md-4 d-none">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="client_address"
                                            value="{{ $booking[0]->client_address }}">
                                        ...
                                        <select name="SupplierID" id="SupplierID" class="form-select select2">
                                            ...
                                            @foreach ($supplier as $value)
                                                <option value="{{ $value->SupplierID }}"
                                                    {{ $value->SupplierID == $booking[0]->SupplierID ? 'selected=selected' : '' }}>
                                ...
                                <div class="col-md-2 d-none">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="vendor_cost" id="vendor_cost"
                                            value="{{ $booking[0]->vendor_cost }}">
                                ...
                                <div class="col-md-2 d-none">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="input_vat" id="input_vat"
                                            value="{{ $booking[0]->input_vat }}" readonly="">
                                ...
                                <div class="col-md-2 d-none">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="cnc_cost" id="cnc_cost"
                                            value="{{ $booking[0]->cnc_cost }}">
                                ...
                                <div class="col-md-2 d-none">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="output_vat" id="output_vat"
                                            value="{{ $booking[0]->output_vat }}" readonly="">
                                ...
                                <div class="col-md-2 d-none">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="profit" id="profit"
                                            readonly="" value="{{ $booking[0]->profit }}">
                                ...
                                <div class="col-md-4 d-none">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="net_invoice" id="net_invoice"
                                            readonly="" value="{{ $booking[0]->net_invoice }}">
                                ...
                                <div class="col-md-4 d-none">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="payment_status" id="payment_status" class="form-select select2">
                                            ...
                                            <option value="Cash"
                                                {{ 'Cash' == $booking[0]->payment_status ? 'selected=selected' : '' }}>Cash
                                            </option>

                                            <option value="Online"
                                                {{ 'Online' == $booking[0]->payment_status ? 'selected=selected' : '' }}>
                                                Online</option>

                                            <option value="Cheque"
                                                {{ 'Cheque' == $booking[0]->payment_status ? 'selected=selected' : '' }}>
                                                Cheque</option>
                                ...
                                <div class="col-md-4 d-none">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="collected_by" id="collected_by" class="form-select select2">
                                            ...
                                            <option value="CNC"
                                                {{ 'CNC' == $booking[0]->collected_by ? 'selected=selected' : '' }}>CNC
                                            </option>

                                            <option value="Vendor"
                                                {{ 'Vendor' == $booking[0]->collected_by ? 'selected=selected' : '' }}>
                                                Vendor</option>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 text-end" id="closeBooking">
                                        @if($booking[0]->end == null)
                                        <button type="submit" class="btn btn-primary w-sm ">Close Booking </button>
                                        @endif
                                    </div>
                            ...
                            <input type="hidden" class="form-control" id="hidden_date"
    ...
    {{-- this filed is used to insert today date with correct format  --}}
