...
<a href="' . URL('/SaleInvoiceViewPDF/' . $row->InvoiceMasterID) . '/'.$row->BranchID.'"><i class="font-size-18 me-1 mdi mdi-file-pdf-outline align-middle me-1 text-secondary"></i></a>
